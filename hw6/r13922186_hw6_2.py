...
generator = pipeline( # Creates a text generation pipeline
    ...
    max_new_tokens=1024, # TODO: Increase max_new_tokens for longer output (Medium Baseline - 4)
    
    # TODO: Use greedy decoding strategy (Medium Baseline - 5)
    num_beams=1,
    do_sample=False,

    # # Default: top-p stategy
    # do_sample=True,
    # temperature=0.6,  # 只在 do_sample=True 時生效
    # top_p=0.9,        # 只在 do_sample=True 時生效
)
adapter_path = './sft/checkpoint-8406' # TODO: Evaluate different checkpoints (Medium Baseline - 1)
...
gsm8k_predictions = []
TEST_N_SHOT = 8 # TODO: give model more examples (Medium Baseline - 3)
gsm8k_train = load_jsonlines('./dataset/gsm8k_train_self-instruct.jsonl')
...
STUDENT_ID = 'r13922186' # TODO: Add your student id
with open(f'./output/{STUDENT_ID}.txt', 'w') as output_f:
